                    ...
                    <div className="flex items-center gap-3 sm:gap-4">
                      ...
                      {info.copyable && (
                        <Button
                          ...
                          className="text-muted-foreground hover:text-primary h-8 w-8 sm:h-10 sm:w-10 flex-shrink-0"
                        >
              ...
              <div className="flex gap-3 sm:gap-4">
                {socialLinks.map((social, index) => (
                  <Button
                    ...
                    variant="outline"
                    size="icon"
                    className={`transition-all duration-300 ${social.color} border-primary/20 hover:border-primary/50 h-10 w-10 sm:h-12 sm:w-12`}
                    asChild
                  >
                ...
                <form ref={formRef} onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      rows={5}
                      required
                      className="bg-background/50 border-border focus:border-primary resize-none text-sm"
                    />
                  </div>
                  ...
                  <Button
                    ...
                    className="w-full bg-gradient-primary hover:opacity-90 text-primary-foreground glow-primary disabled:opacity-50"
                  >
